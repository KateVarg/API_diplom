...
```
git clone https://github.com/KateVarg/reqresin-project-tests
```
</details>
...
1. Открыть [проект на Jenkins](https://jenkins.autotests.cloud/job/reqres-in-project-tests/allure/)
